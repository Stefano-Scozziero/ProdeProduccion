...
const Login = ({navigation}) =>  {
  ...
  const [isGoogleSignInPressed, setIsGoogleSignInPressed] = useState(false)
  const db = database()
  ...
  const authWithGoogle = async () => {
    try {
      ...
      if (!userInfo || !userInfo.data || !userInfo.data.idToken) {
        setIsGoogleSignInPressed(false);
      ...
      <Image source={require('../../../assets/logo.png')} style={styles.image} resizeMode='contain'/>
          ...
          <View style={styles.containerImages}>
            ...
            <Pressable 
              ...
              onPress={() => {
                if (!isGoogleSignInPressed) {
                  setIsGoogleSignInPressed(true);
                  authWithGoogle();
                }
              }}
              disabled={isGoogleSignInPressed}
            >
